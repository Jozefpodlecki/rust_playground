...
#[macro_export]
macro_rules! system_handle_iterator {
    ($buffer_size:expr) => {
        ...
        #[derive(Clone, Copy)]
        pub struct HandleInfo(ntapi::ntexapi::SYSTEM_HANDLE_TABLE_ENTRY_INFO_EX);
        ...
        impl SystemHandleIterator {
            pub fn new() -> Result<Self, NtApiError> {
                unsafe {
                    ...
                    let entry_size = core::mem::size_of::<SYSTEM_HANDLE_TABLE_ENTRY_INFO_EX>();
                    let offset = core::mem::offset_of!(SYSTEM_HANDLE_INFORMATION_EX, Handles);
