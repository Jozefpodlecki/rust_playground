...
use ntapi::{ntapi_base::CLIENT_ID, ntexapi::{
    NtQuerySystemInformation, SYSTEM_PROCESS_ID_INFORMATION, SYSTEM_PROCESS_INFORMATION, SystemProcessIdInformation, SystemProcessInformation
}, ntobapi::NtClose, ntpsapi::{NtCurrentProcess, NtOpenProcess, NtQueryInformationProcess, ProcessImageFileName, ProcessImageFileNameWin32}, ntseapi::NtOpenProcessToken};
use utils::{U16CStackString, println};
use winapi::{shared::{ntdef::{HANDLE, NTSTATUS, OBJECT_ATTRIBUTES, UNICODE_STRING}, ntstatus::STATUS_SUCCESS}, um::{processthreadsapi::{GetCurrentProcess, OpenProcess, OpenProcessToken}, winbase::LookupPrivilegeValueW, winnt::{LUID_AND_ATTRIBUTES, PROCESS_ALL_ACCESS, PROCESS_QUERY_INFORMATION, PROCESS_QUERY_LIMITED_INFORMATION, SE_PRIVILEGE_ENABLED, TOKEN_PRIVILEGES, TOKEN_QUERY}}};
...
pub fn enable_debug_privilege() -> bool {
    unsafe {
        ...
        let result = winapi::um::securitybaseapi::AdjustTokenPrivileges(
            token_handle,
            0,
            &mut tp,
