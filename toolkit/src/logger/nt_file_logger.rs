...
use crate::{BufWriter, File, FileError, Mutex, ProcessEnvironmentBlock, U16CStackString, Write as IoWrite, canonicalize, println};
...
impl NtFileLogger {
    pub fn init(level: LevelFilter) -> Result<&'static NtFileLogger, LoggerError> {
